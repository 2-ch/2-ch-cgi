...
HTML
	...
	$Page->Print(" <title>$title - Lista de Thread</title>\n\n");
	$Page->Print("</head>\n<body>\n\n");
...
<small><a href="./kako/" target="_blank"><b>Kako log armazém é aqui</b></a></small>
</div>
...
<head>
 ...
 <style type="text/css">
	...
	div.board_header { margin: 0 1.0em 0.0em 1.0em; padding: 0.5em; background: #FFF; border-radius: 0.25em / 0.25em; font-size: 1.00em; height: 15em; overflow-y: scroll; }
 	table { margin: 0.5em auto 0.75em auto; padding: 0.10em; border: 1px; }
...
MENU
  ...
  <div align="right"><small><b><a href="./subback.html">Lista de thread é aqui</a></b></small></div>
  </td>
 </tr>
</table>
...
<table border="1" cellspacing="7" cellpadding="3" width="95%" bgcolor="$tblCol" align="center">
 <tr>
  ...
  <input type="submit" value="Para a tela de criação de nova thread"><br>
...
sub PrintResponse
{
	...
	# 表示行数を超えたら省略表示を付加する
		...
		$Page->Print("<font color=\"green\">（Abreviado・・ Para ler tudo ");
		$Page->Print("<a href=\"$path\" target=\"_blank\">aqui</a>");
		$Page->Print(" aperte por favor）</font><br><br></dd>\n");
	}
}
